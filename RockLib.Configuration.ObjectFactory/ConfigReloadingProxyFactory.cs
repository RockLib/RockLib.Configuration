...
namespace RockLib.Configuration.ObjectFactory
{
    ...
    public static class ConfigReloadingProxyFactory
    {
        ...
        private static void AddProperty(TypeBuilder proxyTypeBuilder, PropertyInfo interfaceProperty, MethodInfo baseGetObjectMethod, List<MethodInfo> implementedMethods)
        {
        ...
        private static void AddEvent(TypeBuilder proxyTypeBuilder, EventInfo interfaceEvent, MethodInfo baseGetObjectMethod, 
            Dictionary<EventInfo, FieldBuilder> eventFields, List<MethodInfo> implementedMethods)
        {
#if NET48
