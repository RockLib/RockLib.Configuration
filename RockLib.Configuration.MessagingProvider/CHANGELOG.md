# RockLib.Configuration.MessagingProvider Changelog
...
#### Changed
- RockLib.Configuration.MessagingProvider.4.0.0 -> RockLib.Configuration.MessagingProvider.4.0.1 for vulnerability fix.
